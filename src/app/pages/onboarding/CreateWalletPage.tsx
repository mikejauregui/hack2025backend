      ...
      <Card className="mx-auto w-full max-w-4xl rounded-4xl border-cerise-red-100 bg-white/90 p-10 shadow-[0_20px_60px_rgba(133,30,49,0.08)]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-cerise-red-600">
                Primary wallet funds face-based payments and can be renamed
                later.
              </p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="grid gap-8 lg:grid-cols-2">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label className="text-cerise-red-900">
                Wallet URL (Interledger)
              </Label>
              <Input
                value={formData.wallet_url}
                onChange={(e) =>
                  setFormData({ ...formData, wallet_url: e.target.value })
                }
                required
          ...
          <div className="lg:col-span-2">
            <div className="rounded-3xl border border-dashed border-cerise-red-100 bg-cerise-red-50/80 p-6 text-sm text-cerise-red-700">
              ...
              <p>
                This will be your primary wallet. You can connect additional
                wallets later for business or savings use-cases.
              </p>
            </div>
            <Button
              type="submit"
